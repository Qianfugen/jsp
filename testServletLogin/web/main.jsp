...
<body>
    <div align="center">
        ...
        <form action="emp/empMainServlet" method="get">
            ...
            入职开始日期:<input type="date" name="qStartHiredate" value="<c:if test="${fy.query.qStartHiredate!=''}"><fmt:formatDate value='${fy.query.qStartHiredate}' pattern='yyyy-MM-dd'/></c:if>">
            入职结束日期:<input type="date" name="qEndHiredate" value="<c:if test="${fy.query.qEndHiredate!=''}"><fmt:formatDate value='${fy.query.qEndHiredate}' pattern='yyyy-MM-dd'/></c:if>">
